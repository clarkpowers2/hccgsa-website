...
const groups: PortfolioGroup[] = [
  { cat: 'Hospitality intelligence', items: [
    ...
    ['Haven Shift Bridge™', 'Structured cross-shift operational continuity.'],
    ['Haven Pattern Watch™', 'Recurring issue and property signal monitoring.'],
  ]},
  { cat: 'Research and IP frameworks', items: [['Institutional Alzheimer’s', 'Named organizational condition and research framework.'], ['The Memory Gap', 'Framework for institutional knowledge loss.'], ['Haven Auto Dispatch™', 'Multi-agent task routing and dispatch system.']] },

      ...
      <section className="mx-auto max-w-4xl px-6 pb-16 pt-20 text-center md:pt-28">
        ...
        <div className="mx-auto mt-14 max-w-3xl border-t border-haven-gold/25 pt-12">
          ...
          <figure className="mx-auto mt-9 max-w-xs md:max-w-sm">
            <img src="/nathaniel-clarke.png" alt="Nathaniel Clarke, founder of HCCGSA LLC, holding the &quot;Saving the Youth&quot; award at the Global Leadership Awards" className="w-full rounded-lg border border-haven-gold/25 shadow-lg" width={1148} height={1370} />
            <figcaption className="mt-3 text-sm italic leading-6 text-white/55">Nathaniel Clarke received the &quot;Saving the Youth&quot; honor at the Global Leadership Awards.</figcaption>
          </figure>

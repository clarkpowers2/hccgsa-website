...
export default function App() {
  return <BrowserRouter><div className="flex min-h-screen flex-col bg-white"><Nav /><main className="flex-1"><Routes>
    ...
    <Route path="/contact" element={<Contact />} /><Route path="/founder-story.html" element={<FounderStory />} /><Route path="/founder-story" element={<FounderStory />} /><Route path="*" element={<Home />} />
